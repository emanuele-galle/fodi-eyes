...
type WebcamRegion = 'italy' | 'middle-east' | 'europe' | 'asia' | 'americas';
...
const WEBCAM_FEEDS: WebcamFeed[] = [
  // Italy — iconic Italian cities and landmarks
  { id: 'rome-trevi', city: 'Roma - Fontana di Trevi', country: 'Italy', region: 'italy', channelHandle: '@SkylineWebcams', fallbackVideoId: 'K7MhAKJkeSA' },
  { id: 'rome-pantheon', city: 'Roma - Pantheon', country: 'Italy', region: 'italy', channelHandle: '@SkylineWebcams', fallbackVideoId: 'TkMl0agPzew' },
  { id: 'venice', city: 'Venezia - Rialto', country: 'Italy', region: 'italy', channelHandle: '@SkylineWebcams', fallbackVideoId: 'vPu2dMgfPJE' },
  { id: 'milan-duomo', city: 'Milano - Duomo', country: 'Italy', region: 'italy', channelHandle: '@SkylineWebcams', fallbackVideoId: 'sPKxrgHlihA' },
  { id: 'naples', city: 'Napoli - Golfo', country: 'Italy', region: 'italy', channelHandle: '@SkylineWebcams', fallbackVideoId: '4e_xRNYnSY0' },
  { id: 'florence', city: 'Firenze - Ponte Vecchio', country: 'Italy', region: 'italy', channelHandle: '@SkylineWebcams', fallbackVideoId: 'Bk1_8KOBxaU' },
  { id: 'amalfi', city: 'Amalfi', country: 'Italy', region: 'italy', channelHandle: '@SkylineWebcams', fallbackVideoId: '0mC3JGACoQI' },
  { id: 'stromboli', city: 'Stromboli - Vulcano', country: 'Italy', region: 'italy', channelHandle: '@SkylineWebcams', fallbackVideoId: 'Kdse0OuqA3o' },
...
export class LiveWebcamsPanel extends Panel {
  ...
  private regionFilter: RegionFilter = 'italy';
  ...
  private static readonly ALL_GRID_IDS = ['rome-trevi', 'venice', 'milan-duomo', 'naples'];
