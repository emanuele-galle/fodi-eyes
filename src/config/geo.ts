...
export const INTEL_HOTSPOTS: Hotspot[] = [
  {
    ...
    description: 'Sede del governo italiano e delle istituzioni.',
    status: 'Monitoring',
  },
  {
    id: 'tripoli',
    ...
    description: 'Punto focale crisi migratoria nel Mediterraneo.',
    status: 'Monitoring',
    escalationScore: 3,
    escalationTrend: 'stable' as const,
    escalationIndicators: ['Rotte migratorie attive', 'Instabilità politica', 'Traffico esseri umani'],
  },
  {
    id: 'mediterraneo',
    name: 'Mediterraneo',
    ...
    description: 'Rotte migratorie centrali del Mediterraneo.',
    status: 'Monitoring',
    escalationScore: 3,
    escalationTrend: 'stable' as const,
