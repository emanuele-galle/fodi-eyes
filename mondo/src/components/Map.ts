...
export class MapComponent {
  ...
  private createLayerToggles(): HTMLElement {
    ...
    const fullLayers: (keyof MapLayers)[] = [
      ...
      'military',                                         // military tracking (combined)
      'militaryFlights',                                  // military aircraft only
      'militaryVessels',                                  // military vessels/warships only
      'liveFlights',                                      // live flight tracking (ADS-B)
    ...
    const layerLabelKeys: Partial<Record<keyof MapLayers, string>> = {
      ...
      militaryFlights: 'components.deckgl.layers.militaryFlights',
      militaryVessels: 'components.deckgl.layers.militaryVessels',
      liveFlights: 'components.deckgl.layers.liveFlights',
  ...
  private renderOverlays(projection: d3.GeoProjection): void {
    ...
    // Military Tracking - flights (shown by 'military', 'militaryFlights', or 'liveFlights')
    if (this.state.layers.military || this.state.layers.militaryFlights || this.state.layers.liveFlights) {
    ...
    // Military Vessels (warships, carriers, submarines) - shown by 'military' or 'militaryVessels'
    if (this.state.layers.military || this.state.layers.militaryVessels) {
