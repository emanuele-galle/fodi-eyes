...
// VITE_VARIANT=tech → fodi-eyes.fodivps2.cloud (tech-focused)
// VITE_VARIANT=full → fodi-eyes.fodivps2.cloud (geopolitical)
// VITE_VARIANT=finance → fodi-eyes.fodivps2.cloud (markets/trading)
