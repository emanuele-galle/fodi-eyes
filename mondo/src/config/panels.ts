...
export const LAYER_TO_SOURCE: Partial<Record<keyof MapLayers, DataSourceId[]>> = {
  ...
  militaryFlights: ['opensky', 'wingbits'],
  militaryVessels: ['ais'],
  liveFlights: ['opensky'],
  ais: ['ais'],
  natural: ['usgs'],
...
export const PANEL_CATEGORY_MAP: Record<string, { labelKey: string; panelKeys: string[]; variants?: string[] }> = {
  ...
  marketsFinance: {
    ...
    panelKeys: ['commodities', 'markets', 'economic', 'finance', 'polymarket', 'macro-signals', 'crypto', 'heatmap'],
    variants: ['full'],
  },
  topical: {
  ...
  techMarkets: {
    ...
    panelKeys: ['markets', 'finance', 'crypto', 'economic', 'polymarket', 'macro-signals', 'layoffs', 'monitors'],
    variants: ['tech'],
  },
  ...
  cryptoDigital: {
    ...
    panelKeys: ['crypto', 'crypto-news', 'fintech'],
    variants: ['finance'],
  },
  centralBanksEcon: {
