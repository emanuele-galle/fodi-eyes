...
export class RegulationPanel extends Panel {
  ...
  private renderDeadlineItem(regulation: AIRegulation): string {
    ...
    const formattedDate = deadline.toLocaleDateString('it-IT', {
      year: 'numeric',
      month: 'long',
      day: 'numeric',
      timeZone: 'Europe/Rome',
  ...
  private renderRegulationCard(regulation: AIRegulation): string {
    ...
    const effectiveDate = regulation.effectiveDate
      ? new Date(regulation.effectiveDate).toLocaleDateString('it-IT', { year: 'numeric', month: 'short', timeZone: 'Europe/Rome' })
      : 'TBD';
    ...
    return `
      <div class="country-card stance-${profile.stance}">
        ...
        <div class="country-stats">
          ...
          <div class="stat">
            <span class="stat-value">${new Date(profile.lastUpdated).toLocaleDateString('it-IT', { month: 'short', year: 'numeric', timeZone: 'Europe/Rome' })}</span>
