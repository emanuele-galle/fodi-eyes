...
const VARIANT_META: Record<string, {
  ...
  full: {
    title: 'Fodi-eyes - Intelligence Dashboard Italia',
    description: 'Dashboard di intelligence in tempo reale con focus sull\'Italia. News, mercati, webcam, TV italiane, dati economici e monitoraggio geopolitico.',
    keywords: 'intelligence Italia, dashboard Italia, news italiane, mercati italiani, webcam Italia, TV italiane, dati economici Italia, monitoraggio geopolitico, OSINT Italia, situazione Italia, borsa italiana, meteo Italia, traffico Italia',
    url: 'https://fodi-eyes.fodivps2.cloud/',
    siteName: 'Fodi-eyes',
    shortName: 'Fodi-eyes',
    subject: 'Intelligence Dashboard in tempo reale con focus Italia',
